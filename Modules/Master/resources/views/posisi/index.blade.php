...
@section('module-content')
    ...
    <div class="panel panel-inverse">
        ...
        <div
            ...
            <a href="{{ route('posisi.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
                    aria-hidden="true" style="font-size: 12px"></i></a>
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('posisi.export') }}" class="btn btn-warning btn-sm">
            ...
            <a href="{{ route('role.print') }}" class="btn btn-danger btn-sm">
                ...
                <a href="{{ route('posisi.pdf') }}" class="btn btn-warning btn-sm">
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr class="odd gradeX">
                            ...
                            <td>{{ $item->posisi_nama }}</td>
                            <td>
                                <a href="{{ route('posisi.edit', $item->id) }}">
                                    <i class="fa fa-pencil-square" style="font-size: 14px; margin-right:5px"></i>
                                </a>
                                <a href="{{ route('posisi.destroy', $item->id) }}" data-confirm-delete="true">
                                    <i class="fa fa-trash mx-2" style="font-size: 14px"></i>
                                </a>
                                {{-- <a href="{{ route('posisi.view', $item->id) }}">
