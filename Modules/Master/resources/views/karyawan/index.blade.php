...
@section('module-content')
    ...
    <div class="panel panel-inverse">
        ...
        <div
            ...
            <a href="{{ route('karyawan.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i
                    class="fa fa-plus-square" aria-hidden="true" style="font-size: 12px"></i></a>
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('karyawan.export') }}" class="btn btn-warning btn-sm">
            ...
            <a href="{{ route('role.print') }}" class="btn btn-danger btn-sm">
                ...
                <a href="{{ route('karyawan.pdf') }}" class="btn btn-warning btn-sm">
                    ...
                    @foreach ($data as $item)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="{{ route('karyawan.destroy', $item->id) }}" data-confirm-delete="true">
                                    <i class="fa fa-trash mx-2" style="font-size: 14px"></i>
                                </a>
                                {{-- <a href="{{ route('karyawan.view', $item->id) }}">
