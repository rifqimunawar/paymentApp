...
@section('module-content')
    ...
    <div class="panel panel-inverse">
        ...
        <div
            ...
            <a href="{{ route('jenis_kendaraan.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i
                    class="fa fa-plus-square" aria-hidden="true" style="font-size: 12px"></i></a>
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('jenis_kendaraan.export') }}" class="btn btn-warning btn-sm">
            ...
            <a href="{{ route('role.print') }}" class="btn btn-danger btn-sm">
                ...
                <a href="{{ route('jenis_kendaraan.pdf') }}" class="btn btn-warning btn-sm">
        ...
        <div class="panel-body">
            <table id="data-table-default" width="100%"
                ...
                <thead>
                    <tr>
                        <th width="1%"></th>
                        <th class="text-nowrap">Jenis Kendaraan</th>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{ route('jenis_kendaraan.edit', $item->id) }}">
                                    <i class="fa fa-pencil-square" style="font-size: 14px; margin-right:5px"></i>
                                </a>
                                <a href="{{ route('jenis_kendaraan.destroy', $item->id) }}" data-confirm-delete="true">
                                    <i class="fa fa-trash mx-2" style="font-size: 14px"></i>
                                </a>
                                {{-- <a href="{{ route('jenis_kendaraan.view', $item->id) }}">
