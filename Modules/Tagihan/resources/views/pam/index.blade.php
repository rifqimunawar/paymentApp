  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <div style="display: flex; gap: 10px;">
        ...
        <a href="{{ route('pam.pdf') }}" class="btn btn-warning btn-sm">
      ...
      <table id="data-table-default" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
        <thead>
          <tr>
            ...
            <th class="text-nowrap">Nominal Tagihan Pam</th>
          ...
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td>
                ...
                {{-- <a href="{{ route('pam.destroy', $item->id) }}" data-confirm-delete="true">
                  <i class="fa fa-trash mx-2" style="font-size: 14px"></i>
                </a> --}}
                <a href="{{ route('pam.view', $item->id) }}">
