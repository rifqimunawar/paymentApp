...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('jadwalkan.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
          aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('jadwalkan.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('jadwalkan.pdf') }}" class="btn btn-warning btn-sm">
